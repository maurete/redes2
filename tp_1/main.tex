...
\end{description}
%
\resalt{comentar acerca de las tablas de estado lógico 1, 2, 3.}
%
\begin{figure}[h]
...
Soporta la norma TIA/EIA-644 para LVDS \resalt{ver esta norma y agregar algún comentario, digo yo...}
...
%
El DS34C87T es un conversor \resalt{transceiver se puede decir?} de señales con voltajes TTL ó CMOS a
...
el otro a la controladora Ethernet de la placa de red/motherboard, o directamente al SouthBridge\resalt{?}.
